...
const INSTITUCIONES_POR_LOCALIDAD = {
  "Kennedy": [
    ...
    "Escuela Integral", "Colegio Urbano", "Centro de Estudio", "Instituto Comunitario"
  ],
  "Bosa": [
    ...
    "Centro de Estudio", "Instituto Comunitario"
  ],
  "Suba": [
    ...
    "Instituto Profesional Suba", "Colegio Técnico Integral", "Escuela Distrital"
  ],
  "Engativá": [
    ...
    "Instituto Profesional Engativá"
  ],
  "Tunjuelito": [
...
// Distribución de cantidad de puestos por localidad = 965 total
const DISTRIBUCION = {
  "Kennedy": 49,
  "Bosa": 49,
  "Suba": 50,
...
// Generar 965 puestos con nombres reales
